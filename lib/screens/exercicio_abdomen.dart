...
class ExerciseAbdomen extends StatefulWidget {
  @override
  _ExerciseAbdomenState createState() => _ExerciseAbdomenState();
}

class _ExerciseAbdomenState extends State<ExerciseAbdomen> {
            ...
            child: Column(
              children: [
                Column(
                  children: [
                    Text(
                      'Treinos de Abdômen', // Nome adicionado
                      style: TextStyle(
                        fontSize: 24,
                ...
                SizedBox(height: 20),
                Image.asset(
                  'assets/images/Abdominal_oblico.gif', // Substitua pelo caminho da imagem desejada
                  width: 100,
                  height: 100,
                ),
                SizedBox(height: 20),
                Text(
                  'Abdominal Oblico com a Bola',
                ...
                Image.asset(
                  'assets/images/exercicio-Mountain-climber.gif', // Substitua pelo caminho da imagem desejada
                  width: 100,
                  height: 100,
                ),
                SizedBox(height: 20),
                ...
                Image.asset(
                  'assets/images/prancha-lateral.gif', // Substitua pelo caminho da imagem desejada
                  width: 100,
                  height: 100,
                ),
                SizedBox(height: 20),
